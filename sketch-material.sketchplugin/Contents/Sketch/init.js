...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var options = {
    ...
    width: 320,
    height: 512,
    url: _common_constants__WEBPACK_IMPORTED_MODULE_1__["default"].baseURL + 'gm_styles'
  };
  var panel = new _panel_index__WEBPACK_IMPORTED_MODULE_0__["MDPanel"](options); // panel.listen('drag-end', Icons.convertSvgToSymbol);
});
